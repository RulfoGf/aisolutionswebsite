...
if (!$errors) {	
	...
	try {
    	...
    	// Recipients
    	$mail->setFrom('rg.conagua@gmail.com', 'Sendy');                				// Set Sender    	
		$mail->addAddress('raulguzmanfranco@gmail.com', 'Ultimate Websolutions'); 	// Set Recipients
		$mail->addAddress($_POST['email']); 											// Set email address entered on form
    	$mail->addReplyTo('raulguzmanfranco@gmail.com.com', 'Sendy');          					// Set Reply-to Address
    	$mail->isHTML(true);                                                       
