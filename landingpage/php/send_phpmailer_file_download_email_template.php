...
/* 
	==================================== */
		...
		// Send data to n8n
		$n8n_url = 'https://aisolutions4u.app.n8n.cloud/webhook-test/bf904a61-3448-4816-ae73-78442e6b0ae4';
		$data = array(
			'name' => $customer_name,
	...
	echo '</svg>';
	echo '</div>';    
	echo '<h4>Gracias por contactanos</h4>';
	echo '<small>Revise su correo</small>';
	echo '</div>';
